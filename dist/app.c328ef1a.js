...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"uploads.js":[function(require,module,exports) {
"use strict";
...
var upload = function upload(selector) {
  ...
  var prev = element('div', ['prev']);
  var open = element('button', ['card_btn'], 'Открыть');
  var uploadFile = element('button', ['card_btn', 'primary'], 'Загрузить');
  ...
  var removeHeadler = function removeHeadler(e) {
    ...
    var block = document.querySelector("[data-name=\"".concat(name, "\"]")).closest('.prev_img');
  ...
  var clearPrev = function clearPrev(elem) {
    elem.style.bottom = '4px';
    elem.innerHTML = '<div class="prev_info-progress"></div>';
  };

  var uploadHeandler = function uploadHeandler() {
    prev.querySelectorAll('.prev_remove').forEach(function (item) {
      item.remove();
    });
    var prevInfo = prev.querySelectorAll('.prev_info');
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, i) {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        var block = blocks[i].querySelector('.prev_info-progress');
...
},{"./uploads.js":"uploads.js","firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
